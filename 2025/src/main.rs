...
fn main() {
    ...
    let (first_stage, second_stage) = match day {
        ...
        Day::Day05 => run_solution(&solutions::day05::Solver::new(input)),
        Day::Day06 => run_solution(&solutions::day06::Solver::new(input)),
        ...
        Day::Day11 => run_solution(&solutions::day11::Solver::new(input)),
        Day::Day12 => run_solution(&solutions::day12::Solver::new(input))
    };
